...
<body style="font-family: Open Sans, sans-serif">
    <section class="px-6 py-8">
        <nav class="md:flex md:justify-between md:items-center">
            <div>
                <a href="/laracasts/posts">
                    <img src={{ asset('/images/laracasts/logo.svg' ) }} alt="Laracasts Logo" width="165" height="16">
                </a>
            </div>
        ...
        <footer id="newslatter" class="bg-gray-100 border border-black border-opacity-5 rounded-xl text-center py-16 px-10 mt-16">
            <img src={{ asset('/images/laracasts/lary-newsletter-icon.svg' ) }} alt="" class="mx-auto -mb-6" style="width: 145px;">
            ...
            <div class="mt-10">
                <div class="relative inline-block mx-auto lg:bg-gray-200 rounded-full">
                    ...
                    <form method="POST" action="/laracasts/newslatter" class="lg:flex text-sm">
                        @csrf
                        <div class="lg:py-3 lg:px-5 flex items-center">
                            <label for="email" class="hidden lg:inline-block">
                                <img src={{ asset('/images/laracasts/mailbox-icon.svg' ) }} alt="mailbox letter">
                            </label>
