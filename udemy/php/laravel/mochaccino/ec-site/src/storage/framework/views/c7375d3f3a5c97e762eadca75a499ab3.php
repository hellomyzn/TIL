...
<?php endif; ?>
        ...
        <div class="flex items-center justify-end mt-4">
            <?php if(Route::has('user.password.request')): ?>
                <a class="underline text-sm text-gray-600 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" href="<?php echo e(route('user.password.request')); ?>">
...
<?php endif; ?>
<?php /**PATH /workspace/resources/views/user/auth/login.blade.php ENDPATH**/ ?>